    ...
    public partial class DockWindow : Window
    {
        ...
        private void Window_MouseWheel(object sender, MouseWheelEventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(currentWindowName))
            {
                ...
                CommonWindowOps.SetWindowPos(first.Hwnd,
                    (IntPtr)WindowZIndex.Top, first.Bounds.Left, first.Bounds.Top, first.Bounds.Width, first.Bounds.Height, 0);
                return;
            }
            ...
            foreach (var WindowInfo in windows)
            {
                if (WindowInfo.Title == currentWindowName)
                {
                    ...
                    CommonWindowOps.SetWindowPos(next.Hwnd,
                        (IntPtr)WindowZIndex.Top, next.Bounds.Left, next.Bounds.Top, next.Bounds.Width, next.Bounds.Height, 0);
                    return;
                }
            }
